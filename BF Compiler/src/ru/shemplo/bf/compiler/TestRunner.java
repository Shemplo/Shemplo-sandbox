...
public class TestRunner {
	...
	private static class ByteClassLoader extends ClassLoader {
		...
		public Class <?> defineClass (String name, byte [] body) {
	...
	private final static String CNAME = "Brainfuck";
	...
	public static void main (String... args) {
		...
		cw.visit (V1_8, CLASS_ACCESS, CNAME, 
		...
		mv = cw.visitMethod (MAIN_ACCESS, "main", "(" + NAME_STA + ")V", null, null);
		mv.visitCode ();
		...
		Class <?> token = bcl.defineClass (CNAME, cw.toByteArray ());
		try {
			token.getMethod ("main", String [].class)
	...
	private static void 
		...
		mv.visitFieldInsn (PUTSTATIC, CNAME, "S", "L" + NAME_SC + ";");
		...
		mv.visitFieldInsn (PUTSTATIC, CNAME, "tape", "[I");
		...
		mv.visitFieldInsn (PUTSTATIC, CNAME, "car", "I");
	...
	public static void actionMoveCarriage (MethodVisitor mv, int offset) {
		...
		mv.visitLabel (l0);
		mv.visitLineNumber (LINE++, l0);
		mv.visitFieldInsn (GETSTATIC, CNAME, "car", "I");
		mv.visitIntInsn (BIPUSH, offset);
		mv.visitInsn (IADD);
		mv.visitFieldInsn (PUTSTATIC, CNAME, "car", "I");
	}
	...
	public static void actionChangeValue (MethodVisitor mv, int delta) {
		...
		mv.visitLabel (l0);
		mv.visitLineNumber (LINE++, l0);
		mv.visitFieldInsn (GETSTATIC, CNAME, "tape", "[I");
		mv.visitFieldInsn (GETSTATIC, CNAME, "car", "I");
		mv.visitInsn (DUP2);
		mv.visitInsn (IALOAD);
	...
	public static void actionReadValue (MethodVisitor mv) {
		...
		mv.visitFieldInsn (GETSTATIC, CNAME, "tape", "[I");
		mv.visitFieldInsn (GETSTATIC, CNAME, "car", "I");
		mv.visitFieldInsn (GETSTATIC, CNAME, "S", 
							"L" + NAME_SC + ";");
